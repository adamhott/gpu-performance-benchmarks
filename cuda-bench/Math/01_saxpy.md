...
**Operation count (per element):** one multiplication, one addition → **2 floating-point ops** per \(i\), hence **\(2n\)** useful FP32 ops for the full vector (matches how throughput is often quoted for SAXPY).
